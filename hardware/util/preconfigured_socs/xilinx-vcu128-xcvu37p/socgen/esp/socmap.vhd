...
package socmap is
  ...
  -- APB 84
  -- SPIKEHARD_RTL
  constant spikehard_rtl_0_pindex : integer range 0 to NAPBSLV - 1 := 84;
  constant spikehard_rtl_0_pirq : integer range 0 to NAHBIRQ - 1 := 5;
  constant spikehard_rtl_0_irq_type : integer range 0 to 1 := 0;
  constant spikehard_rtl_0_paddr : integer range 0 to 4095 := 16#100#;
  constant spikehard_rtl_0_pmask : integer range 0 to 4095 := 16#FFF#;
  constant spikehard_rtl_0_paddr_ext : integer range 0 to 4095 := 16#000#;
  constant spikehard_rtl_0_pmask_ext : integer range 0 to 4095 := 16#000#;
  constant spikehard_rtl_0_pconfig : apb_config_type := (
  0 => ahb_device_reg (VENDOR_SLD, SLD_SPIKEHARD_RTL, 0, 0, 5),
  ...
  constant tile_design_point : tile_hlscfg_array := (
    2 => HLSCFG_SPIKEHARD_RTL_BASIC_DMA64,
    others => 0);
